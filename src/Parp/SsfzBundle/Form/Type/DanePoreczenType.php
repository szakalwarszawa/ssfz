...
class DanePoreczenType extends AbstractType
{
    const DECIMAL_FIELDS = [
        ...
        'kwotaoreczenWyplaconychNieodzyskanychNaDzialaniaProdukcyjne',
        ...
        'kwotaoreczenWyplaconychNieodzyskanychNaDzialaniaHandlowe',
    ...
    private function addIntegerFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $fields = [
            ...
            'liczbaoreczenWyplaconychNieodzyskanychNaDzialaniaProdukcyjne',
            ...
            'liczbaoreczenWyplaconychNieodzyskanychNaDzialaniaHandlowe',
