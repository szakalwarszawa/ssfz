...
class NumerUmowyValidator extends ConstraintValidator
{
     ...
     * @var string
     */
    const REGEXP_FUNDUSZ_POZYCZKOWY = '^WKP\_1\/1\.2\.1\/[0-9]\/2([0-9]){3,3}\/([0-9]){2,2}\/([0-9]){2,2}\/u$';
     ...
     * @var string
     */
    const REGEXP_FUNDUSZ_PORECZENIOWY = '^WKP\_1\/1\.2\.2\/[0-9]\/2([0-9]){3,3}\/([0-9]){2,2}\/([0-9]){2,2}\/u$';
