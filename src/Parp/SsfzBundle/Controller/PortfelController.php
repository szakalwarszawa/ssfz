    ...
    public function indexAction(Request $request, $idUmowy, $idSpolki = null)
    {
        ...
        if (!$umowa) {
            $this
                ...
                ->bladKomunikat('Nie znaleziono umowy o przekazanym identyfikatorze.')
            ;
        ...
        if (false === $beneficjent->getUmowy()->contains($umowa)) {
            $this
                ->get('ssfz.service.komunikaty_service')
                ->bladKomunikat('Brak dostępu do umowy o podanym identyfikatorze.')
            ;
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                $this
                    ->getDoctrine()
                    ->getRepository(Spolka::class)
                    ->persistSpolka($spolka, $spolkaP, $uzytkownik->getId())
                ;
                ...
                return $this->redirectToRoute('portfel_dodanie', [
                    'idUmowy' => $idUmowy,
                ]);
            } else {
                $this
        ...
        $this
            ...
            ->datatableSpolki($this, $umowa->getId())
        ;
